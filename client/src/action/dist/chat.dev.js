...
// action/chat.js
// Assuming you have an `Api` folder where you store your API calls
// Action to get all messages for a chat room
var getAllMessages = function getAllMessages(roomId) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return regeneratorRuntime.awrap(api.fetchMessages(roomId));
