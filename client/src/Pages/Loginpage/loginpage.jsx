...
const LoginPage = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      if (loginMethod === "email") {
        ...
        await axios.post(
          "https://youtube-clone-3ge8.onrender.com/api/send-email-otp",
          { email }
        );
      } else {
        // Trigger mobile OTP verification
        await axios.post(
          "https://youtube-clone-3ge8.onrender.com/api/send-mobile-otp",
          { mobileNumber }
        );
      }
      setLoading(false);
  ...
  return (
    <>
      ...
      <h3>press Home to go to Dashboard</h3>
      <h3>press sign in to login with google</h3>
      ...
      <div className="login-container">
        ...
        <button onClick={() => setLoginMethod("mobile")}>
          Login with Mobile
        </button>
