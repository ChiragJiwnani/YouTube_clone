  ...
  return regeneratorRuntime.async(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _req$body = req.body, src = _req$body.src, tgt = _req$body.tgt; // const command = `curl -X POST http://localhost:5000/translate -H "Content-Type: application/json" -d '{"src": "${src}", "tgt": "${tgt}"}'`;

          command = "curl -X POST https://youtubeclone-server.vercel.app/translate -H \"Content-Type: application/json\" -d '{\"src\": \"".concat(src, "\", \"tgt\": \"").concat(tgt, "\"}'");
